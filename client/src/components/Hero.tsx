  ...
  return (
    <section className="overflow-hidden bg-[#17201c] text-white">
      <div className="mx-auto grid max-w-[1600px] lg:min-h-[620px] lg:grid-cols-[0.9fr_1.1fr]">
        <picture className="block aspect-[16/9] lg:order-2 lg:aspect-auto">
        ...
        <div className="flex flex-col justify-center px-6 py-9 sm:px-10 sm:py-12 lg:order-1 lg:px-12 lg:py-16 xl:px-16">
          <p className="mb-5 text-xs font-medium leading-6 tracking-[0.08em] text-white/65 sm:text-sm">
            Christmas light installation · Seattle &amp; Eastside
          </p>
          ...
          <div className="mt-7 flex flex-wrap items-center gap-x-4 gap-y-4 sm:gap-x-6">
            <Button
              onClick={onGetQuote}
              size="lg"
              className="min-h-12 px-5 text-sm font-semibold sm:px-7 sm:text-base"
            ...
            <Link href="/investment-guide" className="inline-flex min-h-11 items-center text-sm text-[#f1dfbb] underline decoration-white/30 underline-offset-4 hover:decoration-white">
              See pricing · from $800
            </Link>
          </div>
          <div className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-2 border-t border-white/15 pt-5 text-xs text-white/70 sm:text-sm">
