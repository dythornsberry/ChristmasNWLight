...
const galleryImages: GalleryImage[] = [
  ...
  { id: 18, src: img20, alt: "Red tree wrap with blue snowmen decorations", category: "Trees", title: "Red Tree with Snowmen" },
  { id: 19, src: img21, alt: "Elegant warm white Christmas lights on home", category: "Warm White", title: "Classic Warm White Elegance" },
  { id: 20, src: img22, alt: "Vibrant multicolor Christmas lights on rooflines", category: "Multicolor", title: "Festive Multicolor Display" },
  { id: 21, src: img23, alt: "Professional tree uplighting in winter snow with warm white landscape lights", category: "Trees", title: "Winter Landscape Lighting" },
  { id: 22, src: img24, alt: "Custom mistletoe style Christmas lights with red and green bulbs at peaks", category: "Custom", title: "Mistletoe Peak Design" },
  { id: 23, src: img25, alt: "Elegant estate gate decorated with red accent lights and warm white uplighting", category: "Custom", title: "Grand Estate Entrance" },
  { id: 24, src: img26, alt: "Complete Christmas light installation on home in winter snow", category: "Warm White", title: "Classic Winter Wonderland" },
  { id: 25, src: img27, alt: "Warm white roofline with red accent lights wrapping entry columns", category: "Custom", title: "Red Column Accent Design" },
  { id: 26, src: img28, alt: "Warm white Christmas lights on rooflines and ridges", category: "Warm White", title: "Ridge and Roofline Display" },
  { id: 27, src: img29, alt: "Modern Bellevue home with warm white Christmas lights and tree uplighting", category: "Warm White", title: "Contemporary Bellevue Home" },
  { id: 28, src: img30, alt: "Warm white roofline with vibrant multicolor Christmas tree", category: "Multicolor", title: "Mixed Style Display" },
  { id: 29, src: homeImg1, alt: "Classic warm white roofline installation on home", category: "Warm White", title: "Classic Warm White Roofline" },
  { id: 30, src: homeImg2, alt: "Modern multicolor Christmas light display on home", category: "Multicolor", title: "Modern Multicolor Display" },
  { id: 31, src: homeImg3, alt: "Traditional warm white Christmas lights on home", category: "Warm White", title: "Traditional Warm White" },
  { id: 32, src: homeImg4, alt: "Contemporary home with stone accent and warm white lights", category: "Warm White", title: "Contemporary Stone Accent" },
