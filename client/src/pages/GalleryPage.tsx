...
const galleryImages: GalleryImage[] = [
  { id: 1, src: stunningEstate, alt: "Stunning estate with extensive custom lighting, wrapped trees, column accents, and landscape features", category: "Custom", title: "Elegant Estate Masterpiece" },
  { id: 2, src: ultraModernLandscape, alt: "Ultra-modern home with extensive landscape lighting, pathway lights, deck accent lighting, and wreath", category: "Custom", title: "Ultra-Modern Landscape Design" },
  { id: 3, src: warmWhiteBushEstate, alt: "Stunning warm white roofline and extensively wrapped bushes creating elegant estate lighting", category: "Warm White", title: "Elegant Warm White Estate" },
  { id: 4, src: gableWreathHome, alt: "Beautiful home with warm white rooflines, multiple gables, decorative wreaths, and snowflake accents", category: "Custom", title: "Classic Gable and Wreath Display" },
  { id: 5, src: modernArchitectureHome, alt: "Modern architectural home with warm white roofline and dramatic landscape lighting", category: "Warm White", title: "Modern Architecture Showcase" },
  { id: 6, src: luxuryModernDeck, alt: "Luxury modern home with custom red and white roofline lighting and deck accents", category: "Custom", title: "Luxury Deck and Roofline" },
  { id: 7, src: glassHomeMulticolor, alt: "Stunning glass home with multicolor rooflines at dusk with beautiful sunset backdrop", category: "Multicolor", title: "Modern Glass Home Display" },
  { id: 8, src: img9, alt: "Spectacular custom tree display", category: "Custom", title: "Premium Display with Wrapped Trees" },
  { id: 9, src: img8, alt: "Modern home with clean warm white", category: "Warm White", title: "Contemporary Classic" },
  { id: 10, src: img12, alt: "Full yard custom design with decorations", category: "Custom", title: "Complete Holiday Scene" },
  { id: 11, src: img16, alt: "Red tree wrap with blue snowmen", category: "Trees", title: "Creative Tree Design" },
  { id: 12, src: img17, alt: "Vibrant multicolor on dark modern home", category: "Multicolor", title: "Striking Night Display" },
  { id: 13, src: img21, alt: "Elegant warm white Christmas lights on home", category: "Warm White", title: "Classic Warm White Elegance" },
  { id: 14, src: img23, alt: "Professional tree uplighting in winter snow with warm white landscape lights", category: "Trees", title: "Winter Landscape Lighting" },
  { id: 15, src: img25, alt: "Elegant estate gate decorated with red accent lights and warm white uplighting", category: "Custom", title: "Grand Estate Entrance" },
  { id: 16, src: img28, alt: "Warm white Christmas lights on rooflines and ridges", category: "Warm White", title: "Ridge and Roofline Display" },
  { id: 17, src: img29, alt: "Modern Bellevue home with warm white Christmas lights and tree uplighting", category: "Warm White", title: "Contemporary Bellevue Home" },
  { id: 18, src: img1, alt: "Multicolor roofline installation on large home", category: "Multicolor", title: "Festive Multicolor Display" },
  { id: 19, src: img2, alt: "Family enjoying custom holiday lighting", category: "Custom", title: "Family Holiday Tradition" },
  { id: 20, src: img3, alt: "Vibrant multicolor roofline with pillars", category: "Multicolor", title: "Bold Multicolor Design" },
  { id: 21, src: img4, alt: "Elegant tree wrap with warm white lights", category: "Trees", title: "Atmospheric Tree Lighting" },
  { id: 22, src: img5, alt: "Beautiful tricolor lights in snow", category: "Multicolor", title: "Winter Wonderland" },
  { id: 23, src: img6, alt: "Child admiring massive lit tree", category: "Trees", title: "Magical Tree Experience" },
  { id: 24, src: img7, alt: "Elegant brick mansion with warm white", category: "Warm White", title: "Classic Mansion Elegance" },
  { id: 25, src: multicolorTreeHome, alt: "Modern home with vibrant multicolor rooflines and wrapped tree with landscape lighting", category: "Multicolor", title: "Vibrant Multicolor and Tree" },
  { id: 26, src: truckInstallHome, alt: "Professional installation in progress with warm white rooflines and Christmas NW truck", category: "Warm White", title: "Professional Installation" },
  { id: 27, src: img10, alt: "Elegant home with unique architecture", category: "Warm White", title: "Architectural Showcase" },
  { id: 28, src: img13, alt: "Tree with firework starburst lights", category: "Trees", title: "Starburst Tree Magic" },
  { id: 29, src: img14, alt: "Warm white roofline with multicolor tree", category: "Multicolor", title: "Mixed Color Harmony" },
  { id: 30, src: img15, alt: "Modern home with warm white and wreath", category: "Warm White", title: "Modern Holiday Elegance" },
  { id: 31, src: img18, alt: "Stunning multicolor tree with full wrap", category: "Trees", title: "Majestic Multicolor Tree" },
  { id: 32, src: img20, alt: "Red tree wrap with blue snowmen decorations", category: "Trees", title: "Red Tree with Snowmen" },
  { id: 33, src: img22, alt: "Vibrant multicolor Christmas lights on rooflines", category: "Multicolor", title: "Festive Multicolor Display" },
  { id: 34, src: img24, alt: "Custom mistletoe style Christmas lights with red and green bulbs at peaks", category: "Custom", title: "Mistletoe Peak Design" },
  { id: 35, src: multicolorModernDeck, alt: "Modern home with multicolor roofline, deck accent lighting, and illuminated columns", category: "Multicolor", title: "Modern Deck and Roofline" },
  { id: 36, src: img27, alt: "Warm white roofline with red accent lights wrapping entry columns", category: "Custom", title: "Red Column Accent Design" },
  ...
  { id: 52, src: warmWhiteBushEstateAngle2, alt: "Warm white estate with illuminated hedge wall and roofline from side angle", category: "Warm White", title: "Illuminated Hedge Display" },
  { id: 53, src: multicolorTwoStoryHome, alt: "Two-story home with multicolor roofline and warm white illuminated bushes", category: "Multicolor", title: "Multicolor with Bush Accents" }
];
