...
- **Portfolio & Gallery**: Curated homepage preview featuring 6 premium installations (Complete Holiday Scene, Family Holiday Tradition, Premium Display with Wrapped Trees, Striking Night Display, Elegant Warm White Estate, Grand Estate Entrance) to showcase bigger jobs and variety with custom work, big trees, multicolor designs, and beautiful warm white bush lighting; full gallery page with optimized 3-section layout: (1) Featured Premium Installations showcasing top 9 photos (including stunning Elegant Warm White Estate with extensively wrapped bushes) to immediately hook visitors, (2) "See These Installations Come to Life" video section with 6 embedded lazy-loaded YouTube Shorts for engagement, (3) "More Premium Installations" with remaining 44 photos for comprehensive browsing (total 53 photos). Gallery includes category filtering, lightbox with correct offset indexing across sections, and technical photo protection on all images: right-click disabled, drag prevention, text selection disabled, and visible "ChristmasNW.com" watermarks (gallery grid, lightbox, homepage portfolio, and before/after slider).
