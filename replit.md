...
- **Portfolio & Gallery**: Curated homepage preview featuring 6 premium installations (Complete Holiday Scene, Creative Tree Design, Classic Warm White Elegance, Classic Winter Wonderland, Contemporary Bellevue Home, Grand Estate Entrance) to showcase bigger jobs and variety; full gallery page with 36 categorized photos, filtering, lightbox, and 5 embedded lazy-loaded YouTube Shorts.
...
- **SEO & ChatGPT Optimization**: 
  ...
  - Descriptive alt text on all 36 gallery images for AI understanding and accessibility
