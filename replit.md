...
- **Portfolio & Gallery**: Curated homepage preview featuring 6 premium installations (Complete Holiday Scene, Family Holiday Tradition, Premium Custom Display, Striking Night Display, Classic Winter Wonderland, Grand Estate Entrance) to showcase bigger jobs and variety with custom work, big trees, multicolor designs, and beautiful winter displays; full gallery page with 50 categorized photos, filtering, lightbox, and 5 embedded lazy-loaded YouTube Shorts. All gallery images include technical photo protection: right-click disabled, drag prevention, text selection disabled, and visible "ChristmasNW.com" watermarks on all images (gallery grid, lightbox, homepage portfolio, and before/after slider).
