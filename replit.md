...
- **Portfolio & Gallery:** A curated preview on the homepage, with a full, dedicated gallery page featuring 17 categorized photos, badge filtering, and a full-screen lightbox with keyboard navigation. Gallery page includes a "Watch Our Installs" video section with 5 embedded YouTube Shorts showcasing finished result walk-throughs from real installations (Halloween displays, tree lighting, permanent lighting). Videos use lazy loading for performance and feature descriptive captions with locations.
- **Social Media Integration:** Footer includes icon links to all official social media profiles (Facebook, Instagram, YouTube, Google Business Profile) for multi-channel engagement. Gallery page includes a "Visit Our YouTube Channel" CTA to drive video engagement.
